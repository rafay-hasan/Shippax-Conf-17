 ...
 *  the "purpose strings" in __Info.plist__ using the keys `NSLocationAlwaysUsageDescription` and `NSLocationWhenInUseUsageDescription`.
 */
...
@property (nullable, nonatomic, retain, readonly) MRLocation *location;
