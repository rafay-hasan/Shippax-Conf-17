...
/// @param session      Session to authenticate with
/// @param completion   Block to be called upon completion with an MRInvite or an error
+ (NSOperation *)acceptInviteWithURL:(NSURL *)url session:(MRSharingSession *)session completion:(void (^_Nullable)(MRFriend *_Nullable friend_, NSError *_Nullable error))completion;
